...
MEMORY
{
	...
	PRU_DMEM_0_1	: org = 0x00000000 len = 0x00000800 CREGISTER=24 /* 8kB PRU Data RAM 0_1 */
	PRU_DMEM_0_2	: org = 0x00000804 len = 0x000017fc
	...
	CM_PER_I2C1_CLKCTRL : org = 0x44E00048 len = 0x4
	CM_PER_I2C2_CLKCTRL : org = 0x44E00044 len = 0x4

	THE_BUFFER              : org = 0x00000800 len = 0x4 /* Shared buf in Shared RAM */
...
SECTIONS {
	...
	.THE_I2C_CLK > CM_PER_I2C2_CLKCTRL, PAGE 1
	.THE_MEMORY_LOCATION > THE_BUFFER, PAGE 1
}
